...
export default function TableDCFValuation ({assumptions, valuation, historicalFinancialData}){
  ...
  <TableContainer component={Paper}>
    <Table className={classes.table} size="small" aria-label="stycky header">
      <TableHead className={classes.TableHeader}>
        <TableRow>
          <TableCell className={classes.TableTitle} align="left">Valuation Us$ Billions</TableCell>
          <TableCell className={classes.TableTitle} align="right"></TableCell>
        </TableRow>
      </TableHead>
      <TableBody>
        <TableRow>
          <TableCell align="left" className={classes.TableRows}>{`Cash Flow Present Value @${Intl.NumberFormat('en-US',{style:'decimal', minimumFractionDigits:2,maximumFractionDigits:2}).format(assumptions.wacc)}%`}</TableCell>
        ...
        <TableRow>
          ...
          <TableCell align="right" className={classes.TableRowsSubtitle} >{Intl.NumberFormat('en-US',{style:'decimal', minimumFractionDigits:1,maximumFractionDigits:1}).format(valuation.equityValue)}</TableCell>
        </TableRow>
        <TableRow>
          <TableCell align="left" className={classes.TableRows}>Total shares</TableCell>
          <TableCell align="right" className={classes.TableRows} >{Intl.NumberFormat('en-US',{style:'decimal', minimumFractionDigits:0,maximumFractionDigits:0}).format(13545)}</TableCell>
        </TableRow>
        <TableRow>
