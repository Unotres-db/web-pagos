...
export default function PaymentAutocomplete ({paymentObject, setTransaccion, isEditField, setIsEditField, variant}){
  ...
  const label = paymentObject.label? paymentObject.label: "Tipo de Pago"
