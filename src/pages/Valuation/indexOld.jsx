...
import TableHistoricalData2 from './TableHistoricalData2';
...
//+++++++
  ...
  useEffect (()=> {  //**************** */
    if (historicalFinancialData){
      ...
      setForecastedFinancialData(calcForecastedCashFlow());
      // -----
      setCombinedFinancialData(createCombinedData(historicalFinancialData, forecastedFinancialData, isCheckedShowPreviousYears,isCheckedDescOrder));
      if (historicalFinancialData[0].cashFlow < 0){
        setIsEstimateFcffOnly(false)
        setIsDisabledChkBox(true);
      } else {
